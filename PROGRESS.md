...
- `kpi_replacement_input_package.zip`에는 세 개의 Anthropic 요청, 등록 신원 선택 파일, 반환 ZIP 생성 명령을 담았다. SHA-256은 `851d8191d215d8d30ab8e5d8df7af47efa55a7418082ec66daf9e6f837650b26`이다.
- 반환 importer는 ZIP을 한 번만 메모리에 읽고, 등록 신원 참조·실제 Anthropic 모델명·패킷 해시·답 어휘·사례 완전성·블라인딩을 검증한다. 정답 확정이나 사람 판단은 대신 만들지 않는다.
