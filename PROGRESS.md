...
- `kpi_replacement_input_package.zip`에는 세 개의 Anthropic 요청, 등록 신원 선택 파일, 반환 ZIP 생성 명령만 담았다. 정답·근거가 있는 내부 후보 파일은 블라인딩을 위해 ZIP에서 제외했다. SHA-256은 `4183d13b5711b421a555b3bb1d6be8bd1284162c91f32593d533a6bd01ac3eff`이다.
