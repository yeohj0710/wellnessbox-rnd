...
- 남은 사람 작업: 백엔드 자격 검증은 이번 범위가 아니었다. 오너 차단이 이름 문자열 비교라는 점, 동일 AI 초안 검토자가 경고에 그치는 점, 면허 ID의 실재를 확인하지 않는 점, 신뢰 원장 대체 경로가 그대로다. 운영 보조자가 현장에서 실제 면허와 자격 확인 방법을 직접 확인해야 한다.
