...
- Primary dataset and cases: `24` passages from `19` sources and frozen evaluation `256` cases. Canonical evidence is `data/original_plan/evidence/op087_op088_counseling_session_service_adapter_smoke_v1.json`, SHA-256 `f7980c6cd3031bf99f5b90a0fd3def0f0698acaa7f1026587e9fc230e416d821`; R&D source commit `51d6d96a4baf1eb9c8d42c269db813946e36eff7`; service source commit `f78604c74795c127a004a7be64cb67c7fe112803`.
