...
# - rerun the enriched OpenAI live smoke after failure-detail capture
# - regenerate the artifact from the shell/session where OPENAI_API_KEY is actually visible
# Expected artifacts:
