...
def build_parser() -> ArgumentParser:
    parser = ArgumentParser(description="Train effect model v1 on rich synthetic cohort")
    parser.add_argument(
        "--dataset",
    ...
    parser.add_argument(
        "--report-json",
        default="artifacts/reports/effect_model_v1_eval.json",
        help="Evaluation report JSON path",
    )
    parser.add_argument(
        "--report-md",
        default="artifacts/reports/effect_model_v1_eval.md",
        help="Evaluation report Markdown path",
    )
    parser.add_argument(
        "--split-json",
        default="artifacts/reports/effect_model_v1_splits.json",
        help="Train/val/test split artifact JSON path",
    )
    parser.add_argument(
        "--feature-schema-json",
        default="artifacts/reports/effect_model_v1_feature_schema.json",
        help="Feature schema JSON path",
    )
    parser.add_argument(
        "--feature-schema-md",
        default="artifacts/reports/effect_model_v1_feature_schema.md",
