...
def build_parser() -> ArgumentParser:
    parser = ArgumentParser(description="Build a next-action workflow contract example")
    parser.add_argument(
        "--request-json",
    ...
    parser.add_argument(
        "--report-md",
        default="artifacts/reports/next_action_workflow_contract_v1.md",
        help="Output markdown report path",
    )
    parser.add_argument(
        "--example-json",
        default="artifacts/reports/next_action_workflow_example_v1.json",
...
def main() -> None:
    ...
    report = summarize_next_action_workflow_contract_v1(
        event,
