...
let state={},activeDraft=null,generatedKeyPath='',draftReviewerId='',currentStepIndex=0,initialStepSelected=false,lastActionError='',pharmacistReviewOpened=sessionStorage.getItem('operationalPharmacistReviewOpened')==='true';
