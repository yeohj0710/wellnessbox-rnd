...
def build_parser() -> ArgumentParser:
    parser = ArgumentParser(
        description="Build PRO improvement summary shared-contract artifact"
    )
    parser.add_argument(
        "--dataset",
    ...
    parser.add_argument(
        "--report-json",
        default="artifacts/reports/pro_improvement_summary_contract_v1.json",
        help="Output JSON report path",
    )
    parser.add_argument(
        "--report-md",
        default="artifacts/reports/pro_improvement_summary_contract_v1.md",
