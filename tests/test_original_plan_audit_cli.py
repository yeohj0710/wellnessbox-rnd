...
def test_original_plan_audit_cli_returns_zero_for_current_manifest() -> None:
    ...
    assert report["claimed_requirement_count"] == 115
...
def test_original_plan_audit_workflow_runs_cli_and_contract_tests() -> None:
    ...
    assert "1912f127a02d158a159ed7edd135f389308a1e6e" in workflow
    assert "d07123903072f5eac7ef7f5021cf8278ca02c9c9" in workflow
    assert "5b6c1f2e86d4bedc9f1e4a197c8eebbe98768613" in workflow
