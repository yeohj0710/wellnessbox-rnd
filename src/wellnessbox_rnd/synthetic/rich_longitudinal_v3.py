...
def _clone_base_user_records(
    *,
    ...
    for base_record in base_user_records:
        ...
        payload["current_supplements"] = _with_structured_current_supplement_doses_v3(
...
def _format_structured_current_supplement_dose_v3(ingredient_key: str) -> str | None:
...
def _with_structured_current_supplement_doses_v3(
    ...
    for supplement in current_supplements:
        ...
        if normalized_supplement.get("dose"):
            ...
            continue
        ingredient_key = _resolve_structured_current_supplement_ingredient_v3(normalized_supplement)
        dose_value = (
            _format_structured_current_supplement_dose_v3(ingredient_key)
...
def _resolve_structured_current_supplement_ingredient_v3(
